...
export default function StoneGuide() {
  ...
  return (
    <section id="pierres" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        ...
        {stones.map((stone) => {
          ...
          return (
            <button
              ...
              className={`shrink-0 inline-flex items-center gap-2 px-4 py-2.5 rounded-full border-2 text-sm font-medium whitespace-nowrap transition-colors ${
                isActive
      ...
      <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-8 lg:gap-14 items-center bg-[var(--color-cream)] rounded-3xl p-6 sm:p-10">
